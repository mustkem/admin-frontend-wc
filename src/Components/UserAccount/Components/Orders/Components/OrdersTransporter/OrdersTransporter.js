...
import OrderDetailTransporter from "../OrderDetailTransporter/OrderDetailTransporter";

import Layout from "../../../MyAccountLayout/MyAccountLayout";
      ...
      <Switch>
                      ...
                      <TabPane eventKey="second">
                        <ul className="list list-orders ">
                          ...
                          {!inProgressOrders.length && (
                            <div className="p-10 m-0-auto wd-100">Empty</div>
                          )}
                        </ul>
                      </TabPane>
        ...
        <Route path={`${path}/:id`}>
          <MyAccountContentLayout pageType="orderDetails">
            <OrderDetailTransporter userDetails={user} />
          </MyAccountContentLayout>
        </Route>
      </Switch>
    </Layout>
